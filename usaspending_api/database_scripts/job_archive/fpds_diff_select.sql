...
(
    SELECT * FROM dblink (
        ...
        'SELECT
            ...
            UPPER(REGEXP_REPLACE(place_of_perform_city_name, E''\s+'', '' '')) AS place_of_perform_city_name,
            ...
            UPPER(REGEXP_REPLACE(legal_entity_state_descrip, E''\s+'', '' '')) AS legal_entity_state_descrip,
            UPPER(REGEXP_REPLACE(legal_entity_zip4, E''\s+'', '' '')) AS legal_entity_zip4,
            ...
            UPPER(REGEXP_REPLACE(place_of_performance_locat, E''\s+'', '' '')) AS place_of_performance_locat,
            UPPER(REGEXP_REPLACE(place_of_performance_state, E''\s+'', '' '')) AS place_of_performance_state,
            UPPER(REGEXP_REPLACE(place_of_perfor_state_desc, E''\s+'', '' '')) AS place_of_perfor_state_desc,
            UPPER(REGEXP_REPLACE(place_of_perform_country_c, E''\s+'', '' '')) AS place_of_perform_country_c,
            UPPER(REGEXP_REPLACE(place_of_perf_country_desc, E''\s+'', '' '')) AS place_of_perf_country_desc,
